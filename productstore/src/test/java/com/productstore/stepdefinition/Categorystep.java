...
//Navigate to laptop
	@When("^Clicking on category to navigate laptop Page$")
	public void clicking_on_category_to_navigate_laptop_Page() {
		// Write code here that turns the phrase above into concrete actions
...
//To click on product
	...
	public void the_user_clicking_on_category() throws InterruptedException, IOException {
		...
		Thread.sleep(4000);
		productcategory.screenShot("src/test/resources/screenshot/laptop.png");
	}
